...
static const char *fsm_strings[] = {
    "---",         "active OPEN", "passive OPEN", "CLOSE",     "SEND",
    "snd SYN",     "snd SYN_ACK", "snd DATA",     "snd ACK",   "snd FIN",
    "snd FIN_ACK", "rcv SYN",     "rcv SYN_ACK",  "rcv DATA",  "rcv ACK",
    "rcv FIN",     "rcv FIN_ACK", "RTO",          "CLOSE",     "LISTEN",
    "SYN_SENT",    "SYN_RCVD",    "ESTABLISHED",  "DATA_SENT", "FIN_SENT",
    "FIN_RCV"};
